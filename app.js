...
function applySavedSubject(subject){
  ...
  const system=subject.calendar_system||'western',dateValue=`${String(subject.birth_year).padStart(4,'0')}-${String(subject.birth_month).padStart(2,'0')}-${String(subject.birth_day).padStart(2,'0')}`;
